...
trans1_2 = Transition()
trans1_2.post = mode2
trans1_2.mapping = {'satellite.y' : 'rocket.height' , 'satellite.x' : 'rocket.x', 'satellite.vx' : 'rocket.vx', 'satellite.vy' : 'rocket.vy'}
...
trans2_3 = Transition()
trans2_3.post = mode3
trans2_3.mapping = {'satellite.y':'satellite.y', 'satellite.x': 'satellite.x', 'satellite.vx': 'satellite.vx', 'satellite.vy': 'satellite.vy' }
...
trans3_2 = Transition()
trans3_2.post = mode2
trans3_2.mapping = {'satellite.y':'satellite.y', 'satellite.x': 'satellite.x', 'satellite.vx': 'satellite.vx', 'satellite.vy': 'satellite.vy' }
